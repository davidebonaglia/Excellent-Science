...
reg top_1 knowledge_diversity_2 knowledge_diversity_2quared $project_character log_tot_cost_proj period_in_months share_of_countries_2 $countries_dummies at_least_one_publ_open_access at_least_one_fund_agency_Univers at_least_one_fund_agency_Ministr at_least_one_fund_agency_ResInst at_least_one_fund_agency_Others $projects $sub_projects $research_areas , vce(robust)
estimates store c1
...
reg log_publ knowledge_diversity_2 knowledge_diversity_2quared n_organizations log_tot_cost_proj period_in_months share_of_countries_2 $countries_dummies at_least_one_publ_open_access at_least_one_fund_agency_Univers at_least_one_fund_agency_Ministr at_least_one_fund_agency_ResInst at_least_one_fund_agency_Others progr_proj_id_MSCA progr_proj_id_ERC $sub_projects $research_areas if type_pj=="MSCA" | type_pj=="ERC", vce(robust)
estimates store d1
...
outreg2 [d1 e1 f1] using prod_model_MSCA_ERC,  excel lab auto(2)  replace title("Productivity Model")  ///
   drop(at_least_one_fund_agency_Others $org_type $research_areas  o.*) ///
...
outreg2 [g1 h1 i1] using prod_model_all_the_others,  excel lab auto(2)  replace title("Productivity Model")  ///
   drop(at_least_one_fund_agency_Others $org_type $research_areas  o.*) ///
