...
gen mono_ben=1 if n_participants==1
replace mono_ben=0 if mono_ben==.

tab mono_ben

sum progr_proj_id_ERC progr_proj_id_FET progr_proj_id_FTI progr_proj_id_ICT progr_proj_id_INFRA progr_proj_id_LEITs progr_proj_id_MSCA progr_proj_id_SC1 progr_proj_id_SC2 progr_proj_id_SC3 progr_proj_id_SC4 progr_proj_id_SC5 progr_proj_id_SC6 progr_proj_id_SC7 progr_proj_id_SEWP if mono_ben ==1

tab mono_ben if action_type_proj_id_MSCAIFEF==1
* 98% monobeneficiary (Marie Curie Individual Fellowships)

tab  mono_ben if action_type_proj_id_MSCAIFGF==1
* no monobeneficiary (Marie Curie Global Fellowships)


tab mono_ben if action_type_proj_id_ERCADG==1
tab mono_ben if action_type_proj_id_ERCCOG ==1
tab mono_ben if action_type_proj_id_ERCPOC ==1
tab mono_ben if action_type_proj_id_ERCPOCLS ==1
tab mono_ben if action_type_proj_id_ERCSTG ==1
tab mono_ben if action_type_proj_id_ERCSyG ==1


*EU countries
tab at_least_one_EU27
sum progr_proj_id_ERC progr_proj_id_FET progr_proj_id_FTI progr_proj_id_ICT progr_proj_id_INFRA progr_proj_id_LEITs progr_proj_id_MSCA progr_proj_id_SC1 progr_proj_id_SC2 progr_proj_id_SC3 progr_proj_id_SC4 progr_proj_id_SC5 progr_proj_id_SC6 progr_proj_id_SC7 progr_proj_id_SEWP if at_least_one_EU27 ==0

sum progr_proj_id_ERC progr_proj_id_MSCA if at_least_one_EU27 ==0
* ERC and MSCA are the programs with the highest percentage of cases where there none of the partecipants is from a EU country
